...
async function Convert()
{
    ...
    const res = await fetch(`https://cdn.jsdelivr.net/npm/@fawazahmed0/currency-api@latest/v1/currencies/${country}.json`)
    const data = await res.json();
    console.log(data)
    ...
    document.getElementById("convertedTxt").innerText = (orgAmt*rates[country2]).toFixed(2) + country2.toUpperCase()
}  